...
public class tables {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            //st.executeUpdate("insert into appuser(userRole,name,mobileNumber,email,password,address,status)values('SuperAdmin','Super Admin','00000','superadmin@testemail.com','admin','Philippines','Active')");
